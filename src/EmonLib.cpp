...
void EnergyMonitor::zeroCalV(double _zeroCalV) {
  zeroCalibV = _zeroCalV;
}

void EnergyMonitor::zeroCalI(double _zeroCalI) {
  zeroCalibI = _zeroCalI;
}
...
void EnergyMonitor::calcVI(unsigned int crossings, unsigned int timeout) {
  ...
  while ((crossCount < crossings) && ((millis() - start) < timeout)) {
    ...
    // sampleV = movingAverage(analogRead(inPinV));
    // sampleI = movingAverage(analogRead(inPinI));
...
int EnergyMonitor::movingAverage(int newReading) {
